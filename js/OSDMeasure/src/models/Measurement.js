...
class Measurement {
    ...
    adjustToZoom(zoom) {
        ...
        this.line.strokeWidth = 10 / zoom;
        this.textObject.fontSize = 40 / zoom;
        // adjust distance between right-most point and text
        this.textObject.left = Math.max(this.p1.x, this.p2.x) + 20 / zoom;
    }
    ...
    render(zoom) {
        ...
        this.textObject = new fabric.Text(text, {
            left: Math.max(this.p1.x, this.p2.x) + 20 / (zoom),
